...
#define CAFFE2_BUILD_STRINGS { \
  {"TORCH_VERSION", "1.9.0"}, \
  {"CXX_COMPILER", "D:/Program Files/Microsoft Visual Studio/2022/Enterprise/VC/Tools/MSVC/14.41.34120/bin/Hostx64/x64/cl.exe"}, \
  {"CXX_FLAGS", "/DWIN32 /D_WINDOWS /GR /EHsc /w /MP /bigobj -DNDEBUG -DUSE_KINETO -DLIBKINETO_NOCUPTI -DSYMBOLICATE_MOBILE_DEBUG_HANDLE"}, \
  {"BUILD_TYPE", "Release"}, \
  {"BLAS_INFO", ""}, \
  {"LAPACK_INFO", ""}, \
  {"USE_CUDA", "OFF"}, \
